...
$rs = $Microcontrolador->listarPorId($id); 
$obj = $rs->fetch_object(); 
?>
    ...
    <div class="container">
        <div class="row geral">
            ...
            <div class="col-md-9">
                ...
                <form method="post" action="../../controllers/Microcontrolador/edit.php">
                <input type="hidden" name="campoId" value="<?php echo $obj->id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input id="idDescricao" class="form-control" type="text" name="campoDescricao" 
                        required value= "<?php echo $obj->descricao; ?>"
                            placeholder="Informe sua Descricao">
                    </div>
